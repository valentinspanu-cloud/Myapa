@extends('layouts.app')
@section('title', 'Editare consumator')
@section('content')
    ...
    <div id="content-main">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1>@lang('general.pages.users.edit_title')</h1>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col-12 col-lg-12">
                    <div class="bg-white shadow-sm box-container">
                        ...
                        <form method="post" class="custom-form--input-spacing"
                              action="{{ route('users.consumer.update', $user->id) }}">
                            ...
                            <div class="md-input-group">
                                <input readonly type="text" name="phone" id="phone" value="{{ $user->phone }}"
                            ...
                            {{--<div class="md-input-group">
                                <input readonly type="password" name="password" id="password" value=""
                            ...
                            <div class="md-input-group md-select-group">
                                <select class="select-text" name="status" id="status" required>
                                    @foreach($statuses as $status)
                                        <option
                                            {{ $user->status == $status['id'] ? 'selected="selected"' : '' }} value="{{ $status['id'] }}">{{ $status['name'] }}</option>
                                    @endforeach
                                </select>
