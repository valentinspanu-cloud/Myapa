                        ...
                        <form method="post" class="custom-form--input-spacing"
                           ...
                           {{-- <div class="md-input-group">
                            ...
                            <div class="form-group">
                                ...
                                <select multiple class="form-control" multiple name="role[]" id="role" required>
                                    @foreach($roles as $role)
                                        <option
                                            {{ in_array($role->name, collect($user->getRoleNames())->toArray()) ? 'selected' : '' }} value="{{ $role->name }}">{{ $role->display_name }}</option>
                                    @endforeach
                                </select>
                            </div>
